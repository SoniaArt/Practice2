...
//сделать проверки!!!!!!!!!!!!!! вводимые значения
	...
	do {
        ...
        if (d != 0) {
            ...
            do {
                ...
                /*else if (check(th) == 0) { printf("Некорректный ввод. Повторите ввод.\n"); getchar(); }*/
            } while (th < 49 || th > 56);
            th = th - '0';

            /*do {
                printf("Выберите тему: "); scanf_s("%d", &th); printf("\n"); getchar();
                if (th < 1 || th > 8) { printf("Некорректный ввод. Повторите ввод.\n"); continue; }
                else if (check(th) == 0) { printf("Некорректный ввод. Повторите ввод.\n");  }
            } while (th < 1|| th > 8 || check(th) == 0);*/
